...
class EighthPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        def calculate_result():
            ...
            if(score==5):
                l1=tk.Label(self,text='"excellent work"',font=("Arial",32,"bold"),bg="light blue",padx=15,pady=5)
                l1.place(x=430,y=400)  
            elif(score>3):
                l2=tk.Label(self,text='"keep practicing"',font=("Arial",32,"bold"),bg="light blue",padx=15,pady=5)
                l2.place(x=430,y=400)   
            else:
                l3=tk.Label(self,text='"stay focused"',font=("Arial",32,"bold"),bg="light blue",padx=15,pady=5)
